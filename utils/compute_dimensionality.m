base_folder = 'C:/Users/liu_s/hierarchical_policy_compression/Kikumoto_Dataset';
cd(base_folder)
addpath(genpath(base_folder))

rawfile_path = "EEG_paper_analysis\Dimension\";
table_path = "EEG_paper_analysis\new_dimensionality_files\";
% subjids = [304,305,306,307,309,310,311,312,314:325,326,327,329,330,331,332];
subjids = [313,328];
...
for subjid =subjids
    ...
    dimensionality_estimates = compute_neural_dimensionality(rawfile_path+raw_filename);
    writetable(dimensionality_estimates, table_path+dimfile_savename)
end


%%
function [dimensionality_estimates] = compute_neural_dimensionality(h5_file)
